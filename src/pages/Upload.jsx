...
const Upload = () => {
  ...
  // STUB: use dropzone library to manage passport upload
  ...
  // STUB: component displays uploaded passport
  ...
  // STUB: component displays details of uploaded passport
  const UploadSummary = () => {
  ...
  // STUB: navigate to biodata page
  const handleClick = () => {
    navigate("/biodata");
  };

  // STUB: reset state values
  const handleReUpload = () => {
    setFiles([]);
    setIsUpload(false);
  };

  // STUB: if passport is uploaded, navigate to upload success page
